# Generated by Django 5.2.6 on 2025-10-16 17:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestion_escolar', '0028_registrocorrespondencia_quien_recibio'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('ver_estadisticas_generales', 'Puede ver las estadísticas generales del dashboard'), ('ver_grafico_distribucion_zona', 'Puede ver el gráfico de distribución por zona'), ('ver_lista_pendientes', 'Puede ver la lista de pendientes próximos'), ('ver_lista_ultimo_personal', 'Puede ver la lista de último personal registrado')),
                'managed': False,
            },
        ),
